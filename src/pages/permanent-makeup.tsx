  ...
  const allServices = [
    {
      ...
      price: "KES 35,000",
      department: "Permanent Make-up",
      description: "Beautifully shaped, filled and defined brows for a polished look.",
    },
    {
      name: "Lips",
      location: "",
    ...
    },
    {
      ...
      price: "KES 30,000",
      department: "Permanent Make-up",
      description: "Precision eyeliner that opens and defines the eyes effortlessly.",
    },
    {
      name: "Touch-up (within 1 month)",
      location: "",
      price: "KES 11,000",
      department: "Permanent Make-up",
      description: "Touch-up recommended within 1 month for best results.",
    },
    {
      name: "Bridal glam",
      location: "1h",
            ...
            .map(dept => {
              ...
              return (
                <div key={dept.id} className="bg-white p-8 md:p-12 shadow-sm">
                  ...
                  {dept.id === "Permanent Make-up" && (
                    <p className="mt-6 text-sm text-[#595959] italic text-center">
                      All permanent makeup services include a consultation and touch-up session.
                    </p>
                  )}
                </div>
              );
