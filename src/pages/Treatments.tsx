  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-20 px-6 bg-white relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[#E2DBDF]/10 via-transparent to-[#C1B5C6]/10"></div>
            ...
            {[
              ...
              <div key={item.step} className="text-center group">
                <div className="relative mb-6">
                  <div className="text-5xl font-medium text-[#C1B5C6] mb-4 group-hover:text-[#595959] transition-colors duration-300">{item.step}</div>
                  {idx < 3 && (
                    <div className="hidden md:block absolute top-1/2 -right-6 w-12 h-[1px] bg-[#C1B5C6]/30"></div>
                  )}
                </div>
                <div className="bg-white/80 p-6 rounded-sm shadow-sm hover:shadow-md transition-shadow duration-300">
                  <h3 className="text-2xl font-medium text-[#262626] mb-3">{item.title}</h3>
                  <p className="text-base text-[#262626] leading-relaxed">{item.description}</p>
                </div>
              </div>
      ...
      {/* Footer Note */}
      <section className="py-16 px-6 bg-[#E2DBDF]/30 relative">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-32 h-[1px] bg-gradient-to-r from-transparent via-[#595959] to-transparent"></div>
        <div className="container mx-auto max-w-4xl text-center">
          <p className="text-base text-[#262626] leading-relaxed bg-white/50 p-8 rounded-sm shadow-sm">
            <span className="font-medium text-lg block mb-2">Please Note:</span> All treatments are consultation-based.
            Pricing and treatment plans will be customized during your initial consultation based on
            your specific needs, desired outcomes, and our expert assessment. Contact us to book your
            consultation and begin your transformation journey.
          </p>
