...
import PRICE from "@/assets/DSC00056-Edit (1).jpg";
  ...
  const serviceCategories = [
    {
      ...
      description: 'Please allow a full hour for all our cutting and styling appointments so that we have sufficient time to understand your needs and you can relax with complimentary drinks from our salon bar.',
      services: [
        { name: 'Haircut', price: 'from Ksh 6,000' },
    ...
    },
    {
      ...
      icon: Heart,
      description: 'Pamper your hands and feet with our luxurious manicure and pedicure services. From classic treatments to gel finishes, we ensure your nails look flawless and feel rejuvenated.',
      services: [
        { name: 'Classic Manicure', price: 'Ksh 7,000', duration: '' },
        { name: 'Classic Pedicure', price: 'Ksh 8,000', duration: '' },
        { name: 'Couture Manicure', price: 'Ksh 7,500', duration: '' },
         { name: 'Couture Pedicure', price: 'Ksh 8,500', duration: '' },
        { name: 'French Gel Manicure', price: 'Ksh 11,000', duration: '' },
        { name: 'French Gel Pedicure', price: 'Ksh 12,000', duration: '' },
        { name: 'French Manicure', price: 'Ksh 7,500', duration: '' },
        { name: 'French Pedicure', price: 'Ksh 8,500', duration: '' },
        { name: 'Gel Manicure', price: 'Ksh 7,500', duration: '' },
        { name: 'Gel Pedicure', price: 'Ksh 8,500', duration: '' },
        { name: 'Polish Change Manicure', price: 'Ksh 3,000', duration: '' },
        { name: 'Polish Change Pedicure', price: 'Ksh 3,000', duration: '' },
        { name: 'Polish Gel Change Manicure', price: 'Ksh 3,500', duration: '' },
        { name: 'Polish Gel Change Pedicure', price: 'Ksh 3,500', duration: '' },
        { name: 'Polish Gel French Change Manicure', price: 'Ksh 3,500', duration: '' },
        { name: 'Polish Gel French Change Pedicure', price: 'Ksh 4,500', duration: '' },
        // { name: 'Shellac soakoff', price: 'Ksh 1,000', duration: '15 mins' },
        // { name: 'Pedicure', price: 'Ksh 4,000', duration: '45 mins' },
        // { name: 'Shellac pedicure', price: 'Ksh 7,000', duration: '1-1h 15 mins' },
        // { name: 'Day glam', price: 'Ksh 4,000', duration: '30 mins' },
        // { name: 'Full glam', price: 'Ksh 5,000', duration: '45 mins' },
        // { name: 'Acrylic extension', price: 'Ksh 8,000', duration: '2 hours' },
        // { name: 'Nail art', price: 'from Ksh 2,000', duration: '30 mins' },
        // { name: 'Bridal glam', price: 'from Ksh 10,000', duration: '1h' },
        // { name: 'Acryllic Infills', price: '7,000', duration: '' },
        // { name: 'Gum Gel Nails', price: '7,000', duration: '' },
        // { name: 'Gum Gel Infills', price: '5,500', duration: '' },
      ],
    },
    {
      ...
      description: 'Complete your look with our nail and makeup services. From everyday elegance to special occasion glamour, we offer a full range of treatments to enhance your natural beauty.',
      services: [
        { name: 'Acrylic French Nail Extension Full Set', price: 'Ksh 15,000', duration: '' },
        { name: 'Acrylic Nail Extension Full Set', price: 'Ksh 13,000', duration: '' },
        { name: 'Acrylic Refill/Overlay', price: 'Ksh 9,000', duration: '' },
        { name: 'Acrylic Removal W/Cleaning', price: 'Ksh 6,000', duration: '' },
        { name: 'Acrylic Gel Removal W/Cleaning', price: 'Ksh 6,000', duration: '' },
        { name: 'Hard Gel French Nail Extension Full Set', price: 'Ksh 16,000', duration: '' },
        { name: 'Hard Gel Nail Extension Full Set', price: 'Ksh 14,000', duration: '' },
        { name: 'Hard Gel Refill/Overlay', price: 'Ksh 9,000', duration: '' },
        { name: 'Soft Gel', price: 'Ksh 9,000', duration: '' },
        { name: 'Buff & Shine Re-Shape', price: 'Ksh 3,500', duration: '' },
        { name: 'Extension Removal', price: 'Ksh 3,500', duration: '' },
        // { name: 'Shellac soakoff', price: 'Ksh 1,000', duration: '15 mins' },
        // { name: 'Pedicure', price: 'Ksh 4,000', duration: '45 mins' },
        // { name: 'Shellac pedicure', price: 'Ksh 7,000', duration: '1-1h 15 mins' },
        // { name: 'Day glam', price: 'Ksh 4,000', duration: '30 mins' },
    ...
    {   id: 'Nail Add-ons',
        title: 'Nail Add-ons',
        icon: Heart,
        description: 'Enhance your nail treatment with our range of add-ons for a personalized experience.',
        services: [
          { name: 'Nail Art/PC', price: 'Ksh 3,500', duration: '' },
          { name: 'Gel Nail Art/PC', price: 'Ksh 3,500', duration: '' },
      ...
      },
    {
      ...
      icon: Palette,
      description: 'Enhance your natural beauty with our professional makeup services. Whether for a special occasion or everyday glam, our skilled artists create flawless looks tailored to you.',
      services: [
        { name: 'Day glam', price: 'Ksh 4,000', duration: '30 mins' },
        { name: 'Full glam', price: 'Ksh 5,000', duration: '45 mins' },
        { name: 'Bridal glam', price: 'from Ksh 10,000', duration: '1h' },
    ...
    },
    {
      ...
      description: 'Perfect your brows and lashes with our lamination and tinting services. Achieve fuller, more defined features that require minimal daily maintenance.',
      services: [
        { name: 'Eyebrows Lamination', price: 'Ksh 9,000' },
        { name: 'Eyelash Lamination', price: 'Ksh 8,000' },
        { name: 'Eyebrow tinting and Shaping', price: 'Ksh 6,000' },
      ],
    },
    {
      id: 'face-fitness',
