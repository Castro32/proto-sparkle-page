    ...
    <div className="min-h-screen bg-black font-sans relative overflow-hidden">
      ...
      {/* <section className="relative h-screen overflow-hidden">
        ...
        <div className="relative h-full flex items-end pb-24 px-6 md:px-12 lg:px-20 z-20">
          <div className="max-w-3xl">
            <h1
              className="text-5xl md:text-7xl lg:text-8xl font-hatton font-light text-[#FFFFFF] mb-8 leading-[1.1] tracking-tight animate-fade-in-up cyber-text glitch"
              style={{ animationDelay: "0.3s", opacity: 0, animationFillMode: "forwards" }}
            >
              Nairobi's Premier<br />
            ...
            <div
              className="mb-6 inline-block neon-border px-6 py-3 rounded-full animate-fade-in-up backdrop-blur-xl bg-black/30"
              style={{ animationDelay: "0.6s", opacity: 0, animationFillMode: "forwards" }}
            >
      ...
      {/* Philosophy Section - Futuristic Redesign */}
      <section
        id="philosophy"
        ref={(el) => (sectionRefs.current.philosophy = el)}
        className="relative py-24 md:py-32 px-6 md:px-12 lg:px-20 overflow-hidden"
      ...
      {/* Services Section - Futuristic Grid */}
      {/* <section
        id="services"
        ref={(el) => (sectionRefs.current.services = el)}
        className="py-24 md:py-32 px-6 md:px-12 lg:px-20 bg-[#E2DBDF] from-black via-gray-900 to-black relative overflow-hidden"
      >
        <div className="absolute top-20 right-0 w-96 h-96 bg-[#B0C2B0]/10 rounded-full blur-[120px] animate-pulse glow" style={{ animationDuration: "4s" }} />
        <div className="absolute bottom-20 left-0 w-96 h-96 bg-[#E2DBDF]/10 rounded-full blur-[120px] animate-pulse glow-accent" style={{ animationDuration: "5s", animationDelay: "1s" }} />
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          >
            <div className="inline-block px-6 py-3 neon-border rounded-full mb-6 backdrop-blur-xl bg-black/40">
              <span className="text-xs tracking-[0.2em] uppercase text-[#B0C2B0] font-medium cyber-text">Standing Out</span>
            </div>
          ...
          <div className={`grid grid-cols-1 md:grid-cols-6 gap-4 lg:gap-6 ${isVisible("services") ? "animate-stagger" : ""}`}>
            ...
            >
              <div className="absolute inset-0">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-br from-[#FFFFFF] via-black/90 to-transparent" />

                <div className="absolute inset-0 holographic opacity-10 group-hover:opacity-20 transition-opacity" />
              </div>

              <div className="absolute inset-0 neon-border rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none" />

              <div className="relative p-8 lg:p-12 h-full flex flex-col justify-end">
                <div className="mb-6 w-16 h-16 rounded-2xl neon-border backdrop-blur-xl bg-black/40 flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300 glow">
                  <svg className="w-8 h-8 text-[#B0C2B0]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                  </svg>
                </div>
                <h3 className="text-3xl lg:text-4xl font-hatton font-light text-white mb-4 transform group-hover:translate-x-2 transition-transform duration-300 cyber-text">
                  Advanced Tricology
                </h3>
                <p className="text-base lg:text-lg leading-relaxed text-gray-300 max-w-xl transform group-hover:translate-x-2 transition-transform duration-300 delay-75">
                  Evidence-based hair and scalp solutions using cutting-edge technology and scientific research.
                </p>
              </div>
            </div>
            ...
            >
              <div className="absolute inset-0">
                <img
                  ...
                  className="w-full h-full object-cover opacity-30 group-hover:opacity-40 group-hover:scale-110 transition-all duration-700"
                />
                <div className="absolute inset-0 bg-gradient-to-br from-[#B0C2B0]/60 via-black/80 to-black" />
              ...
              <div className="relative p-6 lg:p-8 h-full min-h-[280px] flex flex-col justify-end">
                <div className="mb-4 w-12 h-12 rounded-xl neon-border backdrop-blur-xl bg-black/40 flex items-center justify-center transform group-hover:scale-110 group-hover:rotate-12 transition-all duration-300 glow">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />
                  </svg>
                </div>
                <h3 className="text-xl lg:text-2xl font-hatton font-light text-white mb-3 cyber-text">
                  Premium Glam Services
                </h3>
            ...
            >
              <div className="absolute inset-0">
                <img
                  ...
                  className="w-full h-full object-cover opacity-30 group-hover:opacity-40 group-hover:scale-110 transition-all duration-700"
                />
                <div className="absolute inset-0 bg-gradient-to-br from-[#E2DBDF]/40 via-black/80 to-black" />
                <div className="absolute inset-0 holographic opacity-10" />
              </div>
              ...
              <div className="relative p-6 lg:p-8 h-full min-h-[280px] flex flex-col justify-end">
                <div className="mb-4 w-12 h-12 rounded-xl neon-border backdrop-blur-xl bg-black/40 flex items-center justify-center transform group-hover:scale-110 group-hover:-rotate-12 transition-all duration-300 glow-accent">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                  </svg>
                </div>
            ...
            >
              ...
              <div className="relative p-6 lg:p-8 h-full min-h-[300px] flex flex-col justify-end">
                <div className="mb-4 w-12 h-12 rounded-xl neon-border backdrop-blur-xl bg-black/40 flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300 glow">
                  <svg className="w-6 h-6 text-[#B0C2B0]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7" />
                  </svg>
                </div>
                <h3 className="text-2xl lg:text-3xl font-hatton font-light text-white mb-3 cyber-text">
                  Exclusive Experience
                </h3>
            ...
            >
              <div className="absolute inset-0">
                <img
                  ...
                  className="w-full h-full object-cover opacity-30 group-hover:opacity-40 group-hover:scale-110 transition-all duration-700"
                />
                <div className="absolute inset-0 bg-gradient-to-br from-[#B0C2B0]/50 via-black/80 to-black" />
                <div className="absolute inset-0 holographic opacity-10" />
              </div>
            ...
            >
              <div className="absolute inset-0">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-r from-black via-[#E2DBDF]/20 to-black/80" />
                <div className="absolute inset-0 holographic opacity-10" />
              ...
              <div className="relative p-6 lg:p-10 h-full min-h-[200px] flex items-center">
                <div className="flex items-center gap-6 lg:gap-8 max-w-4xl">
                  <div className="w-16 h-16 lg:w-20 lg:h-20 rounded-2xl neon-border backdrop-blur-xl bg-black/40 flex items-center justify-center flex-shrink-0 transform group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 glow-accent">
                    <svg className="w-8 lg:w-10 h-8 lg:h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                  </div>
                  <div>
                    <h3 className="text-2xl lg:text-3xl font-hatton font-light text-white mb-2 cyber-text">
                      Special Pricing Events
                    </h3>
                    <p className="text-sm lg:text-base leading-relaxed text-gray-300">
                      Exclusive moments to enjoy your trusted treatments at special rates. Be part of our inner circle.
  ...
  <div className="max-w-7xl mx-auto relative">
    <div className={`text-center mb-16 transition-all duration-1000 ${isVisible("services") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
      ...
      <h2 className="text-4xl md:text-5xl lg:text-6xl font-hatton font-light text-[#262626] mb-6">
        What Makes Avya <span className="italic text-[#B0C2B0]">Different</span>
      </h2>
