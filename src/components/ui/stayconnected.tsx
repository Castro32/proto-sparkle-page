...
// const StayConnected = () => {
//   return (
//     <div className="w-full flex flex-col items-center gap-4 py-6 px-4 sm:px-0">
//       {/* Title Section */}
//       <div className="w-full sm:w-[70%]">
//         <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-light text-gray-900 tracking-wide text-left">
//           STAY CONNECTED
//         </h2>
//       </div>
...
const StayConnected = () => {
  return (
    <div className="w-full flex flex-col items-center gap-6 py-10 px-4">
      ...
      <div className="w-full max-w-7xl px-4 sm:px-0 flex justify-center">
        <InstagramEmbed
          url="https://www.instagram.com/avyabeautyke?igsh=ZDJocGkwbjM1MWZi"
          width="100%"
        />
