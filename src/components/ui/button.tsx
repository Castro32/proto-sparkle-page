...
//         ghost: "hover:bg-accent hover:text-accent-foreground",
//         link: "text-primary underline-offset-4 hover:underline",
//         hero: "gradient-primary text-primary shadow-soft hover:shadow-elegant hover:scale-105 font-medium tracking-wide",
//         premium: "bg-card text-card-foreground border border-accent hover:bg-accent shadow-soft hover:shadow-elegant",
//       },
//       size: {
//         default: "h-10 px-4 py-2",
//         sm: "h-9 rounded-md px-3",
