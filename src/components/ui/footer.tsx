...
//             <p className="text-xs text-[#595959]">
//               By signing up to receive emails from AVYA, you agree to our{' '}
//               <a href="#" className="underline hover:text-[#B0C2B0]">
//                 Privacy Policy
//               </a>
//               .
//             </p>
...
//                 <a
//                   href="/"
//                   className="text-[#262626] hover:text-[#B0C2B0] transition-colors font-sans"
//                 >
//                   Home
//                 </a>
//               </li>
    ...
    <footer className="bg-[#C1B5C6] text-[#262626] py-12 px-4 md:px-12">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between gap-8">
          {/* Newsletter Section */}
          <div className="space-y-6 flex-1 max-w-md">
            <h2 className="text-5xl md:text-6xl font-light font-serif text-[#262626]">
              Join Our Newsletter.
            </h2>
          ...
          {/* Follow Us Section */}
          <div className="space-y-4 flex-shrink-0">
            <h3 className="text-base uppercase tracking-wider text-[#595959] font-sans">
              Follow Us
            </h3>
            <div className="flex space-x-4">
              <a
          ...
          <div className="space-y-4 flex-shrink-0">
            ...
            <ul className="space-y-2">
              <li>
                <a
                  href="/"
                  className="text-[#262626] hover:text-[#B0C2B0] transition-colors font-sans text-base"
                >
                  Home
                </a>
              </li>
