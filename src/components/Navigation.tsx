...
// // //                 <a
// // //                   href="/"
// // //                   className="text-base md:text-lg lg:text-xl font-hatton font-light text-foreground hover:text-primary transition-colors px-1"
// // //                 >
// // //                   Home
// // //                 </a>
// // //                 <a
...
// // //                 <div className="relative group px-1">
// // //                   <button
// // //                     className="text-base md:text-lg lg:text-xl font-hatton font-light text-foreground hover:text-primary transition-colors flex items-center gap-1"
// // //                   >
// // //                     Services
// // //                     <ChevronDown className="h-3 w-3" />
// // //                   </button>
...
// // //                       <a
// // //                         href="#trichology"
// // //                         className="text-base font-hatton font-light text-muted-foreground hover:text-primary transition-colors py-2"
// // //                         onClick={() => setIsOpen(false)}
// // //                       >
// // //                         Trichology & Scalp Health
// // //                       </a>
...
// //                   src={Logo}
// //                   alt="AVYA Logo"
// //                   className="h-10 sm:h-12 md:h-14 scale-125 object-contain"
// //                 />
// //               </a>
// //             </div>
...
// //               <a
// //                 href="/"
// //                 className="text-base font-hatton font-light text-foreground hover:text-primary transition-colors py-2 border-b border-gray-100"
// //                 onClick={() => setIsOpen(false)}
// //               >
// //                 Home
// //               </a>
...
// //               <div className="border-b border-gray-100">
// //                 <button
// //                   className="text-base font-hatton font-light text-foreground hover:text-primary transition-colors flex items-center justify-between w-full text-left py-2"
// //                   onClick={() => setIsServicesOpen(!isServicesOpen)}
// //                 >
// //                   Services
// //                   <ChevronDown className={`h-4 w-4 transition-transform duration-200 ${isServicesOpen ? 'rotate-180' : ''}`} />
// //                 </button>
// //                 {isServicesOpen && (
// //                   <div className="pb-2 pl-4 flex flex-col gap-2 animate-in slide-in-from-top-2 duration-200">
// //                     <a
// //                       href="#trichology"
// //                       className="text-base font-hatton font-light text-muted-foreground hover:text-primary transition-colors py-1"
// //                       onClick={() => setIsOpen(false)}
// //                     >
// //                       Trichology & Scalp Health
// //                     </a>
...
// //               <a
// //                 href="/contact"
// //                 className="text-base font-hatton font-light text-foreground hover:text-primary transition-colors py-2"
// //                 onClick={() => setIsOpen(false)}
// //               >
// //                 Contact
// //               </a>
...
//   return (
//     <nav className="fixed top-4 left-1/2 transform -translate-x-1/2 z-50 w-[95%] sm:w-[90%]">

//       {/* Main Navigation Bar */}
//       <div className="bg-white/80 backdrop-blur-sm rounded-full items-center shadow-sm w-[1395px] h-[90px] sm:h-auto">
...
//             </div>
//             {/* Desktop Navigation Links */}
//             <div className="hidden md:flex flex-1 justify-end items-center gap-[10px] px-[10px]">
//               <a
//                 href="/"
//                 className="text-base md:text-lg lg:text-xl font-hatton font-light text-foreground hover:text-primary transition-colors px-[10px] py-[10px]"
//               >
//                 Home
//               </a>
//               <a
...
//                 About us
//               </a>
//               <div className="relative group px-[10px] py-[10px]">
//                 <button
...
//               <a
//                 href="/"
//                 className="text-base font-hatton font-light text-foreground hover:text-primary transition-colors py-[10px] border-b border-gray-100"
//                 onClick={() => setIsOpen(false)}
//               >
//                 Home
//               </a>
...
//               <div className="border-b border-gray-100">
//                 <button
//                   className="text-base font-hatton font-light text-foreground hover:text-primary transition-colors flex items-center justify-between w-full text-left py-[10px]"
//                   onClick={() => setIsServicesOpen(!isServicesOpen)}
//                 >
//                   Services
//                   <ChevronDown className={`h-4 w-4 transition-transform duration-200 ${isServicesOpen ? 'rotate-180' : ''}`} />
...
//               <a
//                 href="/contact"
//                 className="text-base font-hatton font-light text-foreground hover:text-primary transition-colors py-[10px]"
//                 onClick={() => setIsOpen(false)}
//               >
//                 Contact
//               </a>
...
const Navigation = () => {
  ...
  return (
    <nav className="fixed top-4 left-1/2 transform -translate-x-1/2 z-50 w-full max-w-[2000px] px-4 sm:px-6">
      ...
      {/* Mobile Menu Dropdown */}
      {isOpen && (
        <div className="md:hidden mt-1 bg-white/95 backdrop-blur-sm rounded-3xl shadow-lg overflow-hidden animate-in slide-in-from-top-5 duration-200 w-full">
          <div className="px-4 py-2">
            <div className="flex flex-col gap-[10px]">
              <a
                href="/"
